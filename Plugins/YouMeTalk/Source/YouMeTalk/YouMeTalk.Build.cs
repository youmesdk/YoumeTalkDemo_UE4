...
public class YouMeTalk : ModuleRules
{
	public YouMeTalk(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicIncludePaths.AddRange(
            new string[] {
                Path.Combine(ModuleDirectory, "YouMeTalkLibrary/include"),
            }
            );

        if (Target.Platform == UnrealTargetPlatform.Win32)
        {
            PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/x86/youme_voice_engine.lib"));

            RuntimeDependencies.Add("$(BinaryOutputDir)/youme_voice_engine.dll", Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/x86/youme_voice_engine.dll"));
        }
        else if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            PublicAdditionalLibraries.Add(Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/x86_64/youme_voice_engine.lib"));

            RuntimeDependencies.Add("$(BinaryOutputDir)/youme_voice_engine.dll", Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/x86_64/youme_voice_engine.dll"));
        }
        else if (Target.Platform == UnrealTargetPlatform.Android)
        {
            string AndroidLibraryPath = Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/android");
        ...
        else if(Target.Platform == UnrealTargetPlatform.IOS)
        {
            ...
            string VivoxLibraryPath = Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/ios");
        ...
        else if (Target.Platform == UnrealTargetPlatform.Mac)
        {
            ...
            // PublicDelayLoadDLLs.Add(Path.Combine(ModuleDirectory, "YouMeTalkLibrary/lib/Mac/Release", "libExampleLibrary.dylib"));
